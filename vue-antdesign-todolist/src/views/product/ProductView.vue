...
<template>
    ...
    <a-row :gutter="24" type="flex">
      ...
      <a-col :span="24" class="mb-24">
        <h1 class="mb-15">Product report</h1>
        ...
        <div>
          <div>
            <div>All receipts quantity: {{ productReport.allReceiptsQuantity }}</div>
          </div>
          <div>
            <div>All postings quantity: {{ productReport.allPostingsQuantity }}</div>
          </div>
          <div>
            <div>Final quantity: {{ productReport.finalQuantity }}</div>
          </div>
          <table>
            <tr>
              <td>
                <h5>Product quantity in cell</h5>
